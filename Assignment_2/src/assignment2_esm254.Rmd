...
Based on the graphs you produced, which model hypotheses look like the fit the model best? We will discuss a more formal method for comparing these models after this assignment is due!

Model 6 fit the model the best - followed by model 5. 
