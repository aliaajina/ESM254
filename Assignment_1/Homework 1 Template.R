...
## Question 1
x <- vector(mode = "logical", length=10) # use the vector() function here
x <- (5:14) # fill in x with number values here
x

## Question 2
Y <- vector(mode = "logical", length = 100)# use the vector() function
Y <- seq(2,200, by=2) # fill in the Y vector here
...
sumN <- function() { # add parameter to this line
...
increasing.mat <- function() { # add parameters to this line
